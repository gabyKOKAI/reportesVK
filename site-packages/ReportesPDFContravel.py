...
class ReportesPDFContravel:
    ...
    def __init__(self, sem, an, mes, diaI, diaF, nomArch, rutArch, repTyp):
        ...
        try:
            ...
            self.wriErr = WriteErrors.WriteErrors()
    ...
    def createReport(self, type):
        ...
        try:
            ...
            if not ".csv" in src:
                self.wriErr.addMensaje("error","Recuerda que debes guardarlo como archivo CSV.")
            else:
            ...
            self.wriErr.addMensaje("info", "Recuerda que: Las cantidades deben tener formato General. El documento no deben tener titulos ni deben existir comas ´,´ en el archivo CSV antes de guardarlo")
