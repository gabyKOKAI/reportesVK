...
class Conciliador:
    ...
    def extractInfoArchivoMontoClave(self):
        ...
        try:
                ...
                for line in file2:
                    if (line[0:3] != ",,,"):
                        ...
                        if (clave not in self.baseTodo):
                            ...
                            tam = 1
                            while (tam in self.baseTodo[clave] and self.baseTodo[clave][tam]["datoAux1"]!="-"):
                                tam = tam + 1
                        ...
                        if (self.baseTodo[clave][1]["dato1"]!="-"):
                            self.baseTodo[clave][tam]["monto"] = self.baseTodo[clave][1]["monto"]
                            self.baseTodo[clave][tam]["fecha"] = self.baseTodo[clave][1]["fecha"]
                            self.baseTodo[clave][tam]["otro"] = self.baseTodo[clave][1]["otro"]
                            self.baseTodo[clave][tam]["dato1"] = self.baseTodo[clave][1]["dato1"]
                            self.baseTodo[clave][tam]["dato2"] = self.baseTodo[clave][1]["dato2"]
                            self.baseTodo[clave][tam]["dato3"] = self.baseTodo[clave][1]["dato3"]
                            self.baseTodo[clave][tam]["dato4"] = self.baseTodo[clave][1]["dato4"]
                            self.baseTodo[clave][tam]["dato5"] = self.baseTodo[clave][1]["dato5"]
                            self.baseTodo[clave][tam]["dato6"] = self.baseTodo[clave][1]["dato6"]
                            self.baseTodo[clave][tam]["dato7"] = self.baseTodo[clave][1]["dato7"]
                            self.baseTodo[clave][tam]["dato8"] = self.baseTodo[clave][1]["dato8"]
                            self.baseTodo[clave][tam]["dato9"] = self.baseTodo[clave][1]["dato9"]
                            self.baseTodo[clave][tam]["dato10"] = self.baseTodo[clave][1]["dato10"]
                            self.baseTodo[clave][tam]["dato11"] = self.baseTodo[clave][1]["dato11"]
                            self.baseTodo[clave][tam]["dato12"] = self.baseTodo[clave][1]["dato12"]
                            self.baseTodo[clave][tam]["dato13"] = self.baseTodo[clave][1]["dato13"]
                            self.baseTodo[clave][tam]["dato14"] = self.baseTodo[clave][1]["dato14"]
                            self.baseTodo[clave][tam]["dato15"] = self.baseTodo[clave][1]["dato15"]
            ...
            self.wriErr.addMensaje("error" + clave + line, err)
            WriteLog.writeLog(nameFunction + line, err)
